...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('Back')); ?>/css/styles.css" rel="stylesheet" />
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <?php echo csrf_field(); ?>
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="name" type="text" name="name"  placeholder="Prity" />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="<?php echo e(route('login')); ?>">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy;  Website <?php echo e(date('Y')); ?></div>
                            <div>
...
<?php /**PATH E:\Php--BASIS\php\htdocs\ustore\resources\views/auth/register.blade.php ENDPATH**/ ?>