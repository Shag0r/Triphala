...
city.addEventListener('input', function () {
    ...
    fetch($url).then(function (response) {
        ...
        // }
            ...
            //         <h4>${crops[i].name}</h4>
            //         <img src="{{ asset('Front/assets/imgs/crop/${crops[i].image}') }}" alt="${crops[i].name}">
            //     </div>
            //     `;
            // }
            ...
            for (let i = 0; i < crops.length; i++) {
                ...
                <div class="col-3">
                    <div class="card">
                    <img src="{{ asset('Front/assets/imgs/crop/${crops[i].image}') }}" class="card-img-top crop-image" alt="${crops[i].name}">
                    <div class="card-body">
