<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{{Route('users.indexinfo')}}">
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{Route('blog')}}">Add Blog</a>
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{Route('video')}}">Add Video&DES</a>
                                    <a class="nav-link" href="{{route('managevideo')}}">Manage Video&DES</a>
                                </nav>
                            </div>
